class UserDetailsController < ApplicationController
  ...
  def index
    ...
    @user_details = @q.result(distinct: true).includes(:events,
                                                       :comments_details).page(params[:page]).per(10)
  end
  ...
  def user_detail_params
    params.require(:user_detail).permit(:user_id, :user_email,
                                        :user_first_name, :password, :user_last_name)
  end
end
